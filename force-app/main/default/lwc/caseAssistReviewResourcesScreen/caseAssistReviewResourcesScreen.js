...
export default class CaseAssistReviewResourcesScreen extends LightningElement {
  labels = {
    previous,
  ...
  connectedCallback() {
    ...
    try {
      if (this.caseData) {
        ...
        console.log("CaseData CaseAssistReviewResourcesScreen.init()" + this._caseData["Subject"])
  ...
  get abandonRequestClass() {
    return this.hasSuggestions ? 'slds-var-m-right_medium' : '';
  }
